...
In the most commonly used foundation of mathematics, Zermelo--Fraenkel set theory with the axiom of choice (discussed at length in \Cref{secZFC}), every mathematical object is a set. This raises the question of: what about the other mathematical objects? For example, if numbers are sets, what sets are they? What about functions and relations?
