...
\end{align*}
Definimos ainda os \textbf{intervalos ilimitados} $(-\infty, a)$, $(-\infty, a]$, $[a, \infty)$ and $(a, \infty)$ \inlatex{infty}\lindexmmc{infty}{$\infty$} por
\begin{align*}
...
\begin{itemize}
\item (⊆\subseteq) Seja a∈{x∈R∣x2≤1}a \in \{ x \in \mathbb{R} \mid x^2 \le 1 \}. Então a∈Ra \in \mathbb{R} and a2≤1a^2 \le 1, para que (1−a)(1+a)=1−a2≥0(1-a)(1+a) = 1-a^2 \ge 0. Segue-se que ou:
\begin{itemize}
\item 1−a≥01-a \ge 0 e 1+a≥01+a \ge 0, nesse caso a≤1a \le 1 e a≥−1a \ge -1, para que a∈[−1,1]a \in [-1,1].
\item 1−a≤01-a \le 0 e 1+a≤01+a \le 0, nesse caso a≥1a \ge 1 and a≤−1a \le -1, o que é uma contradição já que −1<1-1 < 1.
\end{itemize}
...
Mas $\forall a \in E,\, a \in E'$ and $\forall a \in E',\, a \in E$ são ambos verdadeiros por \Cref{exEverythingIsTrueOfElementsOfEmptySet} desde que $E$ e $E'$ sejam vazios. Então $E=E'$, como afirmado.
\end{proof}
